jQuery(function ($){
  var Formoid = (function (){
    ...
    var API_URL = ('https:' == location.protocol ? 'https:' : 'http:') + '//backend.agrmediacion.com/es/api/send_click2call_famedic';
      ...
      recaptchaToken
        ...
        .always(function (){
          var objData = {
            ...
            fuente: docCookies.hasItem('fuente') ? docCookies.getItem('fuente') : '',
            campana: docCookies.hasItem('campana') ? docCookies.getItem('campana') : '',
            gclid: docCookies.hasItem('gclid') ? docCookies.getItem('gclid') : '',
            fclid: docCookies.hasItem('fclid') ? docCookies.getItem('fclid') : '',
            form: {
          ...
          $ajax(API_URL, {
            ...
            try{
              ...
              defer.reject('Respuesta incorrecta de servidor.');
            }
          }).fail(function (){
            var error = 'Falla al preguntarle al servidor. ';
            if ('onLine' in navigator && !navigator.onLine)
              error += 'Sin conexión a internet.';
            else error += 'Verifica la conexión y vuelve a intentarlo.';
            defer.reject(error);
          });
        });
      return defer;
        ...
        inputs.each(function (index, input){
          ...
          if ($input.attr('name') === "email"){
            if (!isValidEmail(input)){
              ...
              def.reject(new Error('Formulario inválido'));
              return false;
            }
          }
          ...
          .then(function (){
            form.send(data)
              ...
              .then(function (message){
                ...
                let date = new Date();
                docCookies.setItem('form-click2call-send', date.getTime() + refresh_time);
                docCookies.setItem('form-click2call-message', alertSuccess || message);
                setTimeout(function (){
